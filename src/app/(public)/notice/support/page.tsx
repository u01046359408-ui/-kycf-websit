          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="rounded-2xl bg-[#111d35] border border-white/10 p-6">
              ...
              <p className="text-gray-300 text-sm leading-relaxed">
                매월 일정 금액을 자동이체로 후원하실 수 있습니다. 정기 후원자에게는 연말정산용
                기부금 영수증을 일괄 발급해 드립니다. 월 1만원부터 참여 가능합니다.
              </p>
            </div>
            <div className="rounded-2xl bg-[#111d35] border border-white/10 p-6">
              <h4 className="text-[#c9a84c] font-semibold mb-3">일시 후원</h4>
              <p className="text-gray-300 text-sm leading-relaxed">
                원하시는 금액을 1회 후원하실 수 있습니다. 아래 계좌로 입금 후 사무국으로
                연락 주시면 기부금 영수증을 발급해 드립니다.
              </p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="rounded-2xl bg-gradient-to-br from-[#111d35] to-[#1a2744] border border-[#c9a84c]/20 p-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                <p className="text-gray-400 text-sm mb-1">은행명</p>
                <p className="text-white font-semibold text-lg">국민은행</p>
              </div>
              <div>
                <p className="text-gray-400 text-sm mb-1">계좌번호</p>
                <p className="text-[#c9a84c] font-semibold text-lg">123-456-789012</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-white font-semibold text-lg">성함 + &quot;후원&quot;</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {benefits.map((b, i) => (
              <div
                key={i}
                className="rounded-2xl bg-[#111d35] border border-white/10 p-6 hover:border-[#c9a84c]/30 transition-colors"
              >
                <div className="w-10 h-10 rounded-full bg-[#c9a84c]/10 flex items-center justify-center mb-4">
                  <span className="text-[#c9a84c] font-bold text-sm">{String(i + 1).padStart(2, "0")}</span>
                </div>
        ...
        <section>
          ...
          <div className="rounded-2xl bg-[#111d35] border border-white/10 p-8">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div>
                <p className="text-gray-400 text-sm mb-1">담당부서</p>
                <p className="text-white font-medium">사무국 후원팀</p>
              </div>
              <div>
                <p className="text-gray-400 text-sm mb-1">전화번호</p>
                <p className="text-white font-medium">02-1234-5678</p>
              </div>
              <div>
                <p className="text-gray-400 text-sm mb-1">이메일</p>
                <p className="text-white font-medium">support@daehantalent.or.kr</p>
              </div>
            </div>
          </div>
        </section>
