...
export default function AboutTalentPage() {
  ...
  const fallbackContent = `인재 인증이란?

한국유소년체스연맹 인증 제도는 각 분야에서 뛰어난 역량과 잠재력을 갖춘 인재를 공식적으로 인정하고 증명하는 국가 공인 인증 시스템입니다. 체계적인 평가 과정을 통해 개인의 전문성을 객관적으로 검증하며, 인증을 받은 인재에게는 다양한 혜택과 기회를 제공합니다.

역량 기반 평가 - 개인의 전문 역량과 잠재력을 체계적으로 평가하여 공정하고 객관적인 인증을 제공합니다.
공인 인증 시스템 - 한국유소년체스연맹가 공식적으로 인정하는 인증서를 발급하며, 이는 국내외에서 공신력을 갖춘 자격 증명입니다.
단계별 등급 체계 - 초급, 중급, 고급, 전문가 등 4단계 등급 체계를 통해 지속적인 성장과 발전을 지원합니다.
커뮤니티 네트워크 - 인증을 받은 인재들 간의 교류와 협력을 촉진하는 전국적 네트워크를 운영합니다.

인증 절차 안내

한국유소년체스연맹 인증은 아래의 4단계 절차를 통해 진행됩니다. 각 단계는 공정성과 투명성을 기반으로 운영됩니다.

01. 지원 및 접수 - 온라인 또는 오프라인으로 인증 평가에 지원합니다. 필요한 서류를 제출하고 평가 일정을 확인합니다.
02. 서류 심사 - 제출된 서류를 기반으로 기본 자격 요건 충족 여부를 심사합니다. 학력, 경력, 교육 이수 내역 등을 확인합니다.
03. 실기 평가 - 해당 분야의 전문 역량을 직접 평가합니다. 실무 능력, 문제 해결 능력, 창의성 등을 종합적으로 심사합니다.
04. 인증서 발급 - 평가를 통과한 지원자에게 공식 인증서를 발급합니다. 인증서는 온라인에서도 진위 확인이 가능합니다.

인증 혜택

한국유소년체스연맹 인증을 취득하면 다양한 분야에서 혜택을 누릴 수 있습니다.

공식 자격 증명 - 한국유소년체스연맹 공인 인증서를 통해 전문성을 공식적으로 입증할 수 있습니다.
경력 개발 지원 - 인증 등급에 따른 맞춤형 교육 프로그램과 경력 개발 컨설팅을 제공합니다.
교육 기회 확대 - 인증 보유자에게 전문 교육 과정 우선 등록 및 수강료 할인 혜택을 드립니다.
대회 참가 자격 - 인증 등급에 따라 각종 대회 및 경진대회 참가 자격이 부여됩니다.
네트워킹 기회 - 동일 분야 인증 보유자들과의 교류 및 멘토링 프로그램에 참여할 수 있습니다.
취업 및 진학 우대 - 협력 기관 취업 시 우대 혜택과 대학원 진학 시 가산점이 적용됩니다.

지금 바로 한국유소년체스연맹 인증 평가에 지원하여 당신의 전문성을 공식적으로 인정받으세요.`;
