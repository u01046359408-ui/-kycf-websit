  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <PageEditableWrapper pageKey="about-talent">
          ...
          <section className="mb-20">
            <div className="text-center mb-12">
              ...
              <div className="text-gray-400 max-w-3xl mx-auto leading-relaxed text-base sm:text-lg space-y-3">
                <p>한국유소년체스연맹 인증 제도는 각 분야에서 뛰어난 역량과 잠재력을 갖춘 인재를 공식적으로 인정하고 증명하는 국가 공인 인증 시스템입니다. 체계적인 평가 과정을 통해 개인의 전문성을 객관적으로 검증하며, 인증을 받은 인재에게는 다양한 혜택과 기회를 제공합니다.</p>
              </div>
            </div>
