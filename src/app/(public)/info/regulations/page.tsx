...
export default function RegulationsPage() {
  ...
  const fallbackContent = `한국유소년체스연맹 대회 경기규정

본 규정은 한국유소년체스연맹가 주최 및 주관하는 모든 대회의 공정한 운영을 위해 제정되었습니다. 모든 참가자와 관계자는 본 규정을 숙지하고 준수해야 합니다. 본 규정은 2024년 1월 1일부터 시행됩니다.
...
부칙: 본 규정은 2024년 1월 1일부터 시행한다. 본 규정 시행 이전에 개최된 대회에 대해서는 종전의 규정을 적용한다. 본 규정에 명시되지 않은 사항은 운영위원회의 결정에 따른다.`;
