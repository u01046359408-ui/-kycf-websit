...
export const metadata = {
  title: "경기규정 - 대한인재",
  description: "대한인재 대회 경기 규정, 진행 규칙, 심사 기준에 대한 안내입니다.",
};
...
const regulations = [
    ...
    rules: [
      {
        article: "제1조 (목적)",
        content:
          "본 규정은 대한인재가 주최 및 주관하는 각종 대회의 공정한 운영과 참가자의 권익 보호를 목적으로 한다.",
      },
      {
        article: "제2조 (적용 범위)",
        content:
          "본 규정은 대한인재가 주최, 주관 또는 승인하는 모든 대회에 적용된다. 다만, 개별 대회의 특수성을 고려하여 세부 규정을 별도로 정할 수 있다.",
      },
      {
        article: "제3조 (용어의 정의)",
        content:
          '본 규정에서 사용하는 용어의 정의는 다음과 같다.\n1. "대회"란 대한인재가 공인하는 인재 경진 활동을 말한다.\n2. "참가자"란 대회에 출전하는 인증 보유자를 말한다.\n3. "심사위원"이란 대한인재가 위촉한 평가 전문가를 말한다.\n4. "운영위원회"란 대회의 운영 전반을 관장하는 기구를 말한다.',
      },
      {
        article: "제4조 (대회의 종류)",
        content:
          "대한인재가 개최하는 대회는 다음과 같이 분류한다.\n1. 전국 인재 경진대회\n2. 지역별 예선 대회\n3. 분야별 전문 대회\n4. 신인 발굴 대회\n5. 기타 대한인재가 승인하는 대회",
      },
      {
        article: "제5조 (운영위원회)",
        content:
          "대회의 원활한 운영을 위해 운영위원회를 구성하며, 위원장 1명, 부위원장 2명, 위원 5명 이상으로 구성한다. 운영위원회는 대회 계획 수립, 심사위원 위촉, 결과 확정 등의 권한을 가진다.",
      },
    ],
  },
  {
    ...
    rules: [
      {
        article: "제11조 (경기 일정)",
        content:
          "대회 일정은 개최 60일 전까지 공고하여야 하며, 부득이한 사정으로 일정이 변경되는 경우 최소 14일 전에 참가자에게 통보하여야 한다.",
      },
      {
        article: "제12조 (경기 방식)",
        content:
  ...
  },
  {
    ...
    rules: [
      {
        article: "제21조 (심사위원 구성)",
        content:
          "심사위원은 해당 분야 전문가 5인 이상으로 구성하며, 심사위원장은 운영위원회에서 선임한다. 심사위원은 참가자와 이해 관계가 없어야 한다.",
      },
      {
        article: "제22조 (채점 기준)",
        content:
          "채점은 다음 기준에 따라 100점 만점으로 실시한다.\n1. 전문 지식 (30점): 분야별 이론적 지식 수준\n2. 실무 능력 (35점): 과제 수행 능력 및 완성도\n3. 창의성 (20점): 독창적 문제 해결 접근법\n4. 의사소통 (15점): 발표력 및 논리적 표현력",
      },
      {
        article: "제23조 (채점 절차)",
        content:
          "채점은 블라인드 방식으로 진행하며, 최고점과 최저점을 제외한 나머지 점수의 평균으로 최종 점수를 산출한다. 채점 결과는 심사위원 전원의 서명을 받아 확정한다.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    rules: [
      {
        article: "제36조 (이의신청 절차)",
        content:
          "경기 결과에 이의가 있는 참가자는 결과 발표 후 14일 이내에 서면으로 이의신청을 할 수 있다. 이의신청서에는 이의 사유, 관련 증빙자료를 첨부하여야 한다.",
      },
      {
        article: "제37조 (이의심사위원회)",
        content:
          "이의신청이 접수되면 이의심사위원회를 구성하여 30일 이내에 심사 결과를 통보한다. 이의심사위원회는 기존 심사위원이 아닌 별도의 전문가 3인 이상으로 구성한다.",
      },
    ],
  },
];
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                본 규정은 대한인재가 주최 및 주관하는 모든 대회의 공정한 운영을
                위해 제정되었습니다. 모든 참가자와 관계자는 본 규정을 숙지하고
                준수해야 합니다. 본 규정은 2024년 1월 1일부터 시행됩니다.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <aside className="lg:col-span-1">
            <div className="bg-white/5 backdrop-blur border border-white/10 rounded-2xl p-5 sticky top-24">
              <h3 className="text-sm font-semibold text-[#c9a84c] uppercase tracking-wider mb-4">
                목차
              </h3>
              <nav className="space-y-1">
                {tableOfContents.map((item) => (
                  <a
                    key={item.id}
                    href={`#${item.id}`}
                    className="flex items-center gap-2 py-2 px-3 rounded-lg text-sm text-gray-400 hover:text-white hover:bg-white/5 transition-all duration-200 group"
                  >
                    <ChevronRight className="w-3 h-3 text-[#c9a84c]/50 group-hover:text-[#c9a84c] transition-colors duration-200" />
                    <span className="text-[#c9a84c]/70 text-xs font-mono shrink-0">
                      {item.chapter}
                    </span>
          ...
          <div className="lg:col-span-3 space-y-8">
                ...
                <div className="divide-y divide-white/5">
                  {section.rules.map((rule) => (
                    <div key={rule.article} className="px-6 py-5">
                      <h4 className="text-sm font-semibold text-[#d4b85c] mb-2">
                        {rule.article}
                      </h4>
            ...
            <div className="bg-[#c9a84c]/5 border border-[#c9a84c]/20 rounded-2xl p-5">
              <p className="text-sm text-gray-400 leading-relaxed">
                <span className="text-[#c9a84c] font-semibold">부칙:</span> 본
                규정은 2024년 1월 1일부터 시행한다. 본 규정 시행 이전에
                개최된 대회에 대해서는 종전의 규정을 적용한다. 본 규정에
                명시되지 않은 사항은 운영위원회의 결정에 따른다.
              </p>
            </div>
          </div>
        </div>
