...
export const metadata = {
  title: "경기규정 - 한국유소년체스연맹",
  description: "한국유소년체스연맹 대회 경기 규정, 진행 규칙, 심사 기준에 대한 안내입니다.",
};
    ...
    rules: [
      {
        article: "제1조 (목적)",
        content:
          "본 규정은 한국유소년체스연맹가 주최 및 주관하는 각종 대회의 공정한 운영과 참가자의 권익 보호를 목적으로 한다.",
      },
      {
        article: "제2조 (적용 범위)",
        content:
          "본 규정은 한국유소년체스연맹가 주최, 주관 또는 승인하는 모든 대회에 적용된다. 다만, 개별 대회의 특수성을 고려하여 세부 규정을 별도로 정할 수 있다.",
      },
      {
        article: "제3조 (용어의 정의)",
        content:
      ...
      },
      {
        article: "제4조 (대회의 종류)",
        content:
          "한국유소년체스연맹가 개최하는 대회는 다음과 같이 분류한다.\n1. 전국 인재 경진대회\n2. 지역별 예선 대회\n3. 분야별 전문 대회\n4. 신인 발굴 대회\n5. 기타 한국유소년체스연맹가 승인하는 대회",
      },
      {
        article: "제5조 (운영위원회)",
        content:
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                본 규정은 한국유소년체스연맹가 주최 및 주관하는 모든 대회의 공정한 운영을
