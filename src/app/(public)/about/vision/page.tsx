  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <PageEditableWrapper pageKey="vision">
          <div className="space-y-20">
            ...
            <section className="flex justify-center">
              <div className="relative max-w-2xl w-full rounded-2xl border border-[#c9a84c]/30 bg-gradient-to-br from-[#1a2744] to-[#111d35] p-10 text-center shadow-lg shadow-[#c9a84c]/5">
                ...
                <div className="mt-4 text-gray-400 leading-relaxed space-y-2">
                  <p>한국유소년체스연맹는 모든 사람이 자신의 잠재력을 발휘할 수 있도록 교육과 인증의 기회를 제공하며, 대한민국 인재 생태계의 중심이 되겠습니다.</p>
                </div>
              </div>
            </section>
