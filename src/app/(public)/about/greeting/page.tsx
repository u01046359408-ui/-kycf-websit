  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <PageEditableWrapper pageKey="greeting">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
            <div className="lg:col-span-1 flex flex-col items-center">
              ...
              <div className="mt-6 text-center">
                <p className="text-xl font-bold text-[#1B2A4A]">홍 길 동</p>
                <p className="mt-1 text-sm text-[#C5963A]">(사)한국유소년체스연맹 이사장</p>
              </div>
            </div>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="pt-4 text-right">
                <p className="text-gray-400 text-sm">(사)한국유소년체스연맹 이사장</p>
                <p className="text-[#1B2A4A] text-lg font-semibold mt-1">홍 길 동</p>
              </div>
            </div>
          </div>
        </PageEditableWrapper>
