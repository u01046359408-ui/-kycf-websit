        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <p className="text-gray-300 leading-relaxed">
              안녕하십니까. (사)한국유소년체스연맹 이사장 홍길동입니다.
              바쁘신 와중에도 저희 한국유소년체스연맹 홈페이지를 방문해 주신 여러분께
              깊은 감사의 말씀을 드립니다. 한국유소년체스연맹는 &ldquo;사람이 곧
            ...
            <p className="text-gray-300 leading-relaxed">
              ...
              바로 &lsquo;사람&rsquo;입니다. 한국유소년체스연맹는 시대가 요구하는
            ...
            <p className="text-gray-300 leading-relaxed">
              ...
              한국유소년체스연맹는 앞으로도 변함없이 대한민국의 인재 양성을 위해
              최선을 다할 것을 약속드립니다.
            </p>
