  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <PageEditableWrapper pageKey="instructor">
          {/* Overview */}
          <div className="mb-12">
            ...
            <div className="text-gray-400 leading-relaxed max-w-3xl space-y-3">
              <p>한국유소년체스연맹 지도사 양성과정은 인재개발 분야의 전문 지도 인력을 양성하기 위한 체계적인 교육 프로그램입니다. 총 100시간의 이론 및 실습 교육을 통해 현장에서 즉시 활동할 수 있는 역량을 갖춘 지도사를 배출합니다.</p>
            </div>
          </div>
